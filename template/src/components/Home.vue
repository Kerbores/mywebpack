...
export default {
  data() {
    return {
      ...
      imageUrl: "",
      uploadAction: config.http.baseUrl + "/image/avatar"
    };
  },
  computed: {
    ...mapState({
      ...
      logo: function() {
        return "https://ss0.bdstatic.com/94oJfD_bAAcT8t7mm9GUKT-xh_/timg?image&quality=100&size=b4000_4000&sec=1525918123&di=8f8a2c459b0547b125087dde1068ddf9&src=http://img.zcool.cn/community/01786557e4a6fa0000018c1bf080ca.png";
        // return this.loginUser.headKey
        //   ? config.http.baseUrl + "/image/" + this.loginUser.headKey
        //   : config.http.baseUrl + "/image/avatar";
      }
    }),
  ...
  created() {
    console.log(
      this.$api.Application.list(1, result => {
        console.log(1);
      })
    );
  }
